...
- I reckoned from the form example image above, that each section could have been separated into individual wizard page, but I decided not to do it, as it was a little too much to implement in this exercise.
...
- In real world form, question about other languages should not be required, so no languages selected should be a valid option, but I've let it be how it was defined.
